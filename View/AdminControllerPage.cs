...
namespace Camphor.View {
    public partial class AdminPage : Form {
        ...
        private void addButton_Click (object sender, EventArgs e) {
            ...
            while (true) {
                try {
                    ...
                    adminManager.AddStudentParticulars(adminAddStudentPage.matric, adminAddStudentPage.name, adminAddStudentPage.password, adminAddStudentPage.school);
                    ListViewItem lvi = new ListViewItem(new[] { adminAddStudentPage.name, adminAddStudentPage.matric, adminAddStudentPage.password, adminAddStudentPage.school });
        ...
        private void editButton_Click (object sender, EventArgs e) {
            ...
            AdminAddStudentPage adminEditStudentPage = new AdminAddStudentPage(lvi.SubItems[1].Text, lvi.SubItems[0].Text, lvi.SubItems[2].Text, lvi.SubItems[3].Text);
            adminEditStudentPage.ShowDialog();
            adminButtonsDisable();
            if (!adminEditStudentPage.checkSaved) return;
            adminManager.ChangeStudentParticulars(adminEditStudentPage.matric, adminEditStudentPage.name, adminEditStudentPage.password, adminEditStudentPage.school);
            lvi.SubItems[0].Text = adminEditStudentPage.name;
            lvi.SubItems[2].Text = adminEditStudentPage.password;
            lvi.SubItems[3].Text = adminEditStudentPage.school;
