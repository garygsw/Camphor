...
namespace Camphor.Controller {
    class StudentParticularsManager {
        ...
        public void ChangeStudentParticulars (string matric, string name, string password, string school) {
        ...
        public void AddStudentParticulars (string matric, string name, string password, string school) {
